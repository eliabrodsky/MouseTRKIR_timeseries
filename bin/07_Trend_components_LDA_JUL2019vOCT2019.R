...
### Script to perform linear discriminant analysis (LDA) on the trend component of all the feature between mouse that died (July 2019) and survived (October 2019)
...
png('LDA_Healthy_Sick_trend_all.png', width = 9, height = 7, units = "in", res = 300, pointsize = 12)
...
png('LDA_Ordn_Healthy_Sick_trend_all.png', width = 9, height = 7, units = "in", res = 300, pointsize = 12)
# Combine combined plot and legend using plot_grid()
